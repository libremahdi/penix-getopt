...
- The second part is called opt_name, which is the name of the option you want to define. You are not allowed to use spaces, but if you do, no error will be raised.
